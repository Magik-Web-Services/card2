...
<head>
    ...
    <link rel="stylesheet" href="<?php echo INV_ASSETS; ?>/../../css/style.css">
    <title>Card</title>
</head>

<body>
    <?php
    if (empty($_SESSION['loggedin']) && empty($_SESSION['userID']) && empty($_SESSION['rand'])) {
        echo "<script>window.location.href = '../../index.php'</script>";
    } else {
        $id = $_SESSION['rand'];
        $sql = "SELECT * FROM `card2_data` WHERE `rand_str`='$id'";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result);
        $id = $row['rand_str'];
        $id2 = $_GET['editcard'];
        if ($id == $id2) {
            $company = $row['companyImg'] != "-" ? $row['companyImg'] : "../../images/cover.svg";
            $profileImg = $row['profileImg']  != "-" ? $row['profileImg'] : "../../images/profile.svg";
            $cover = $row['coverImg']  != "-" ? $row['coverImg'] : "../../images/logo.png";
        } else {
            echo "<script>window.location.href = '../../index.php'</script>";
        }
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql1 = "UPDATE `card2_data` SET `companyImg`='$CompanyImg',`profileImg`='$profileImg',`coverImg`='$CoverImg',`profile`='$Profile',`social`='$Socail',`modified_data`=CURRENT_TIMESTAMP() WHERE `rand_str`=`$id`";

            mysqli_query($conn, "UPDATE `card2_data` SET `companyImg`='$CompanyImg',`profileImg`='$profileImg',`coverImg`='$CoverImg',`profile`='$Profile',`social`='$Socail',`modified_data`=CURRENT_TIMESTAMP() WHERE `rand_str`='$id'");
            echo "<script>window.location.href = '../index.php'</script>";
        }
    }
        ...
        <section class="d-flex">
            <div class="left">
                <div class="card" id="image-cropper-result">
                    <img src=<?php echo $company; ?> class="card-img-top" id="company-img" alt="bg-img">
                    <div class="card-body pt-5 ps-4">
                        <!-- profile -->
                        <div class="card_profile mb-5">
                            <img class="img" id="profile-img" alt="Profile" src=<?php echo $profileImg; ?>>
                            <img class="img2" id="cover-img" alt="park realty" src=<?php echo $cover; ?>>
                        </div>
                        <!--  -->
                        ...
                        if (!empty($row['profile'])) {
                            ...
                            if (array_key_exists('Name', $ar)) {
                                ...
                                if (array_key_exists('firstname', $name)) {
                                    echo '<div class="card_border profile_con modal_open" data-box="Name" data-con="Name" data-id="name_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                            <h5 class="card-title fs-2"> ';

                                    if (array_key_exists('prefix', $name)) {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="prefix">' . $name['prefix'] . '</span>&nbsp;';
                                    } else {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="prefix"></span>';
                                    }

                                    echo '<span class="field_card" data-Tfield="Name" data-text1="firstname">' . $name['firstname'] . '</span>&nbsp;';


                                    if (array_key_exists('preferredname', $name)) {
                                        echo '<span class="extra_text" data-extra="preferredname" id="extra_preferredname">
                                                "<span class="field_card" data-Tfield="Name" data-text1="preferredname">' . $name['preferredname'] . '</span>"
                                            </span>&nbsp;';
                                    } else {
                                        echo '<span class="extra_text d-none" data-extra="preferredname" id="extra_preferredname">
                                                "<span class="field_card" data-Tfield="Name" data-text1="preferredname"></span>"
                                            </span>';
                                    }

                                    if (array_key_exists('middlename', $name)) {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="middlename">' . $name['middlename'] . '</span>&nbsp;';
                                    } else {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="middlename"></span>';
                                    }

                                    if (array_key_exists('lastname', $name)) {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="lastname">' . $name['lastname'] . '</span>&nbsp;';
                                    } else {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="lastname"></span>';
                                    }

                                    if (array_key_exists('suffix', $name)) {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="suffix">' . $name['suffix'] . '</span>&nbsp;';
                                    } else {
                                        echo '<span class="field_card" data-Tfield="Name" data-text1="suffix"></span>';
                                    }

                                    if (array_key_exists('maidenname', $name)) {
                                        echo '<span class="extra_text" data-extra="maidenname" id="extra_maidenname">
                                                (<span class="field_card" data-text1="maidenname">' . $name['maidenname'] . '</span>)
                                            </span>&nbsp;';
                                    } else {
                                        echo '<span class="extra_text d-none" data-extra="maidenname" id="extra_maidenname">
                                                (<span class="field_card" data-text1="maidenname"></span>)
                                            </span>';
                                    }


                                    if (array_key_exists('pronouns', $name)) {
                                        echo '<span class="extra_text fs-6" style="color: #6f7a80;" data-extra="pronouns" id="extra_pronouns">
                                                (<span class="field_card" data-Tfield="Name" data-text1="pronouns">' . $name['pronouns'] . '</span>)
                                            </span>&nbsp;';
                                    } else {
                                        echo '<span class="extra_text d-none fs-6" style="color: #6f7a80;" data-extra="pronouns" id="extra_pronouns">
                            ...
                            // Jobs
                            if (array_key_exists('jobTitle', $ar)) {
                                $job = (array) $ar['jobTitle'];
                                if (array_key_exists('j_title', $job)) {
                                    echo '
                                        <div class="card_border profile_con modal_open" data-box="jobTitle" data-con="jobTitle" data-id="job_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                        <h6 class="card-title fs-4"><span class="field_card" data-Tfield="jobTitle" data-text1="j_title">' . $job['j_title'] . '</span></h6>
                                        <i class="card_edit fa-solid fa-pen-to-square"></i>
                                        </div>
                                        ';
                                } else {
                                    echo '<div class="field_card_none card_border profile_con modal_open" data-box="jobTitle" data-con="jobTitle" data-id="job_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                            ...
                            // Department
                            if (array_key_exists('Department', $ar)) {
                                $Department = (array) $ar['Department'];

                                if (array_key_exists('department', $Department)) {
                                    echo '
                                        <div class="card_border profile_con modal_open" data-box="Department" data-con="Department" data-id="deparment_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                        <h6 class="card-title fs-4"><span class="field_card" data-Tfield="Department" data-text1="department">' . $Department['department'] . '</span>
                                        </h6>
                                        <i class="card_edit fa-solid fa-pen-to-square"></i>
                                    </div>
                                    ';
                                    ...
                                    echo '
                                        <div class="field_card_none card_border profile_con modal_open" data-box="Department" data-con="Department" data-id="deparment_field" data-bs-toggle="modal"     <div class="field_card_none card_border profile_con modal_open" data-box="Department" data-con="Department" data-id="deparment_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                ...
                                // Company
                                if (array_key_exists('companyName', $ar)) {
                                    $companyName = (array) $ar['companyName'];

                                    if (array_key_exists('company', $companyName)) {
                                        echo '<div class="card_border profile_con modal_open" data-box="companyName" data-con="companyName" data-id="company_name_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                            <h6 class="card-title fs-4"><span class="field_card" data-Tfield="companyName" data-text1="company">' . $companyName['company'] . '</span>
                                            </h6>
                                            <i class="card_edit fa-solid fa-pen-to-square"></i>
                                        </div>';
                                    } else {
                                        echo '<div class="field_card_none card_border profile_con modal_open" data-box="companyName" data-con="companyName" data-id="company_name_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                ...
                                // Accreditations
                                if (array_key_exists('Accreditations', $ar)) {
                                    $Accreditations = (array) $ar['Accreditations'];

                                    if (array_key_exists('accreditations', $Accreditations)) {
                                        echo '<div class="card_border profile_con modal_open" data-box="Accreditations" data-con="Accreditations" data-id="accred_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                            <ul class="card-title card_accreditations">
                                                <li class="field_card" data-label="Accreditations" data-Tfield="Accreditations" data-text1="accreditations">' . $Accreditations['accreditations'] . '</li>
                                            </ul>
                                            <i class="card_edit fa-solid fa-pen-to-square"></i>
                                        </div>';
                                    } else {
                                        echo '<div class="field_card_none card_border profile_con modal_open" data-box="Accreditations" data-con="Accreditations" data-id="accred_field" data-bs-toggle="modal" data-bs-target="#fildetail">
                                            <ul class="card-title card_accreditations">
                                ...
                                // Headline
                                if (array_key_exists('Headline', $ar)) {
                                    $Headline = (array) $ar['Headline'];

                                    if (array_key_exists('headline', $Headline)) {
                                        echo '<div class="card_border profile_con modal_open" data-box="Headline" data-con="Headline" data-id="headline_field" data-bs-toggle="modal" data-bs-toggle="modal" data-bs-target="#fildetail">
                                                <h6 style="width: 80%;" class="field_card card-title fs-6" data-Tfield="Headline" data-text1="headline">' . $Headline['headline'] . '</h6>
                                            </div>';
                                    } else {
                                        echo '<div class="field_card_none card_border profile_con modal_open" data-box="Headline" data-con="Headline" data-id="headline_field" data-bs-toggle="modal" data-bs-toggle="modal" data-bs-target="#fildetail">
                        ...
                        <div class="card-text social_medias d-flex flex-column pt-3" id="sm_con">
                            ...
                            if (($row['social'] != "-")) {
                                ...
                                $objitems =  json_decode($socal);
                                $array = array_values(get_object_vars($objitems));
                                // echo "<pre>";
                                // print_r($array);
                                // echo "</pre>";
                                $len = count($array);
                                ...
                                for ($x = 0; $x < $len; $x++) {
                                    $arr = $array[$x];
                                    $array2 = array_values(get_object_vars($arr));
                                    $heading = $array2[0];
                                    $subheading = $array2[1];
                                    $dataID = $array2[2];
                                    $id = $array2[3];
                                    ...
                                    $sql2 = "SELECT * FROM `card2_svgs` WHERE `name`='$dataID'";
                                    $result2 = mysqli_query($conn, $sql2);
                                    $row2 = mysqli_fetch_assoc($result2);
                                    $svg = $row2['svg'];


                                    echo '<div class="social_media modal_open social_media_con sm_con2 mb-3" data-val1="' . $val1 . '" data-val2="' . $val2 . '" data-con2="' . $dataID . '" data-id="' . $id . '" id="' . $dataID . '" data-bs-toggle="modal" data-bs-target="#fildetail">
                                    <span class="social_media_icon d-flex justify-content-center align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" style="width: 30px;" class="card_svg">
                                        ' . $svg . '
                                    </svg>
                                </span>
                                    <span class="social_media_para_con ms-3">
                                        <div class="social_media_para card_text1 fs-7 fw-bold lh-2" data-Text="' . $val1 . '">' . $heading . '</div>
                                        <input class="valHidden" data-hidden="' . $val1 . '" name="socail[' . $dataID . '][heading]" value="' . $heading . '" type="hidden">

                                        <div class="social_media_para card_text2 fs-7 lh-1 fw-lighter" data-Text="' . $val2 . '">' . $subheading . '</div>
                                        <input class="valHidden" data-hidden="' . $val2 . '" value="' . $subheading . '" name="socail[' . $dataID . '][subheading]" type="hidden">

                                        <input class="valHidden" name="socail[' . $dataID . '][svg]" value="' . $dataID . '" type="hidden">
                                        <input class="valHidden" name="socail[' . $dataID . '][id]" value="' . $id . '" type="hidden">
                                        <input class="valHidden" name="socail[' . $dataID . '][val1]" value="' . $val1 . '" type="hidden">
                                        <input class="valHidden" name="socail[' . $dataID . '][val2]" value="' . $val2 . '" type="hidden">
                                    </span>
                                    <i class="card_edit fa-solid fa-pen-to-square"></i>
                                </div> 
                                    ';
                        ...
                        <div id="ps_con">
                            ...
                            if (isset($row['profile'])) {
                                ...
                                $obj =  json_decode($profile);
                                $ar = array_values(get_object_vars($obj));
                                $len2 = count($ar);

                                foreach ($ar as $key => $value) {
                                    $ary = $ar[$key];
                                    $ary1 = array_values(get_object_vars($ary));

                                    $ary12 = get_object_vars($ary);

                                    // echo '<pre>';
                                    // print_r($ary12);
                                    // echo '</pre>';
                                    $dataID2 = $ary12['dataid'];

                                    foreach ($ary12 as $key1 => $value1) {
                                        if ($key1 == 'id') {
                                        } else {
                                            echo '<input type="hidden" class="valHidden ps_hidden" data-Hfield="' . $dataID2 . '" name="profile[' . $dataID2 . '][' . $key1 . ']" value="' . $value1 . '" data-hidden="' . $key1 . '">';
                                        }
                                    }
                                }
                            }
                    ...
                    <div class="right_images_box_container">
                        ...
                        <div class="image_box">
                            <div class="image_box_inner">
                                ...
                                <div class="img-logo1">
                                    <img id="uploadlogo" class="img-con" src=<?php echo $company ?> height="148" alt="your image" style="display: block;" class="float-end" />
                        ...
                        <div class="image_box">
                            <div class="image_box_inner">
                                ...
                                <div class="img-logo1">
                                    <img id="uploadlogo2" class="img-con2" src=<?php echo $profileImg ?> style="display:
                                    block;" height="148" alt="your image" class="float-end" />
                        ...
                        <div class="image_box">
                            <div class="image_box_inner">
                                ...
                                <div class="img-logo1">
                                    <img id="uploadlogo3" class="img-con3" src=<?php echo $cover ?> style="display:
                                    block;" height="148" alt="your image" class="float-end" />
                        ...
                        <div id="img_con">
                            ...
                            if (($row['companyImg']) != '-') {
                                echo '<input type="hidden" class="imgHidden" value=' . $row['companyImg'] . ' name="images[Company]" id="Hcompanyimg">';
                            } else {
                                echo '<input type="hidden" class="imgHidden" id="Hcompanyimg">';
                            }
                            if ($row['profileImg']  != '-') {
                                echo '<input type="hidden" class="imgHidden" value=' . $row['profileImg'] . ' name="images[Profile]" id="HProfileimg">';
                            } else {
                                echo '<input type="hidden" class="imgHidden" id="HProfileimg">';
                            }

                            if ($row['coverImg']  != '-') {
                                echo '<input type="hidden" xws class="imgHidden" value=' . $row['coverImg'] . ' name="images[Cover]" id="Hcoverimg">';
                            } else {
                                echo ' <input type="hidden" class="imgHidden" id="Hcoverimg">';
                            }
                        ...
                        <div class="OnboardingLayout_forward-button__1ldwn step1 next" data-step="2" data-full-width="false">
                            <div data-state="tooltip-hidden" data-reach-tooltip-trigger="">
                                <div class="next_step" style="cursor: pointer;">
                                    <button type="submit" style="color: white; font-weight: 500;" class="btn Button_button-content__qRzkt">Edit
                                </div>
                            ...
                            <div class="input_container">
                                ...
                                <div class="email field_box" id="email_field">
                                    <div class="mb-4 mt-4 updown">
                                        ...
                                        <input type="email" class="form-control" data-input="Email" id="email" aria-describedby="email">
                                    </div>
                                    <div class="mb-4 mt-4 updown">
                                        <label for="option" class="form-label">Label (Optional)</label>
                                        <input type="text" class="form-control" data-input="Email" id="e_option" aria-describedby="e_option">
                                    </div>
                                ...
                                <div class="company_url field_box" id="company_field">
                                    ...
                                    <div class="mb-4 updown">
                                        ...
                                        <input type="text" class="form-control" value="opkokpok" data-input="companyUrl" id="c_url" aria-describedby="c_url">
                                    </div>
                                    <div class="mb-4 updown">
                                ...
                                <div class="add field_box" id="venmo_field">
                                    ...
                                    <div class="mb-4 updown">
                                        ...
                                        <input type="text" class="form-control" data-input="venmo_title" value="314" id="venmo_title" aria-describedby="venmo_title">
                                    </div>
                                </div>
                                <!--  -->
